...
// Hapus penyakit
  if ($module == 'penyakit' AND $act == 'hapus') {
    mysqli_query($connect, "DELETE FROM penyakit WHERE kode_penyakit='$_GET[id]'");
...
// Input penyakit
  elseif ($module == 'penyakit' AND $act == 'input') {
    ...
    mysqli_query($connect, "INSERT INTO penyakit(
...
// Update penyakit
  elseif ($module == 'penyakit' AND $act == 'update') {
    ...
    if ($fileName) {
      ...
      mysqli_query($connect, "UPDATE penyakit SET
