<title>Beranda - Sistem Pakar Swamedikasi</title>
<?php 
  $htgejala=mysqli_query($connect, "SELECT count(*) as total from gejala");
	...
	<div class='row'>
        ...
        <!-- ./col -->
<?php 
	$htpenyakit=mysqli_query($connect, "SELECT count(*) as total from penyakit");
	  $dtpenyakit=mysqli_fetch_assoc($htpenyakit); ?>
        ...
        <!-- ./col -->
<?php 
	$htpengetahuan=mysqli_query($connect, "SELECT count(*) as total from basis_pengetahuan");
	  $dtpengetahuan=mysqli_fetch_assoc($htpengetahuan); ?>
        ...
        <!-- ./col -->
<?php 
	$htadmin=mysqli_query($connect, "SELECT count(*) as total from admin");
...
<div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner">
                  <div class="item active">
                    <img src="aset/banner/banner.png" alt="First slide">
                    <div class="carousel-caption">
                    </div>
                  </div>
                  <div class="item">
                    <img src="aset/banner/banner1.png" alt="Second slide">
                    <div class="carousel-caption">
                    </div>
                  </div><!--
                  <div class="item active">
            ...
            <div class="row">
                <div class="col-sm-4 text-center padding wow fadeIn animated" data-wow-duration="1000ms" data-wow-delay="300ms" style="visibility: visible; animation-duration: 1000ms; animation-delay: 300ms; animation-name: fadeIn;">
                    <div class="single-service">
                            ...
                            <img src="aset/banner/responsive.png" alt="">
                      
                        <h2>Aplikasi Responsif</h2>
                        <p>Aplikasi sistem pakar ini dapat menyesuaikan ukuran perangkat anda.</p>
                    </div>
                </div>
                <div class="col-sm-4 text-center padding wow fadeIn animated" data-wow-duration="1000ms" data-wow-delay="600ms" style="visibility: visible; animation-duration: 1000ms; animation-delay: 600ms; animation-name: fadeIn;">
                    <div class="single-service">
                            ...
                            <img src="aset/banner/user.png" alt="">
                        
                        <h2>Membantu pengguna</h2>
                        <p>Sistem Pakar dibuat sesuai dengan aturan yang ditetapkan oleh pakar dan akan terus ditingkatkan.</p>
                    </div>
                </div>
                <div class="col-sm-4 text-center padding wow fadeIn animated" data-wow-duration="1000ms" data-wow-delay="900ms" style="visibility: visible; animation-duration: 1000ms; animation-delay: 900ms; animation-name: fadeIn;">
                    <div class="single-service">
                        ...
                        <h2>Admin Pakar</h2>
                        <p>Terdapat fitur admin pakar, untuk mengatur pengetahuan dan CF pakar.</p>
                    </div>
                </div>
            </div>
        <div></div>