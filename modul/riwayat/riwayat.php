<title>Riwayat - Sistem Pakar Swamedikasi</title>
...
//jumlah data yang ditampilkan perpage
        ...
        $sqlgjl = mysqli_query($connect, "SELECT * FROM gejala order by kode_gejala+0");
        ...
        $tampil = mysqli_query($connect, "SELECT * FROM hasil ORDER BY id_hasil");
        ...
        if ($baris > 0) {
		  ...
		  <tbody>
		  ";
            $hasil = mysqli_query($connect, "SELECT * FROM hasil ORDER BY id_hasil limit $offset,$limit");
            $no = 1;
            $no = 1 + $offset;
            $counter = 1;
...
$hasilg = mysqli_query($connect, "SELECT hasil_id, count(hasil_id) jlh_id FROM hasil group by hasil_id ORDER BY jlh_id desc");
