...
<html><head>
    ...
    <base href="http://localhost/sp_swamedikasi_/">
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="./" class="logo">
          ...
          <span class="logo-lg"><b><i class="fa fa-contao" aria-hidden="true"></i> SP_Swamedikasi</b></span>
        </a>
        <!-- Header Navbar -->
                      ...
                      <li class="user-header">
                        ...
                        <p>
                         Login sebagai <?php echo ucfirst($_SESSION['username']); ?>
                          <small>Pakar dari Pengobatan Swamedikasi</small>
                        </p>
                      </li>
                      <!-- Menu Body -->
                      <!-- <li class="user-body"> -->
...
function kirimContactForm(){
    ...
    if(nama.trim() == '' ){
        ...
        <strong><div class="cinta">Copyright © 2020 - Made with <i class="fa fa-heart pulse"></i> by <a href="#" target="_blank">Nurul Farha</a></div></strong>
      </footer>
